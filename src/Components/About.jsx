        ...
        <Container id={props.id}>
            ...
            <Row className = 'my-2'>       
                <Col sm={12} md={12} lg={12}>
                    <Carousel className = 'shadow rounded p-3'>
                        {testimonios.map((testimonio, index) => (
                            <Carousel.Item className = 'testimonio'>
                                <Carousel.Caption>
                                    <h4 className ='text-center font-italic'>{testimonio.texto}</h4>
                                    {testimonio.firma.map((firma,index) => (<h6 className='text-center font-weight-bold m-0 p-0' key={index}>{firma}</h6>))}
                                </Carousel.Caption>
                            </Carousel.Item>
                        ))}
                    </Carousel>
